# Generated by Django 6.0.6 on 2026-07-06 13:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=20, unique=True, validators=[django.core.validators.RegexValidator(message='Numéro de téléphone invalide.', regex='^\\+?[0-9]{8,15}$')])),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='users/avatar/')),
                ('role', models.CharField(choices=[('ADMIN', 'Administrateur'), ('MANAGER', 'Gestionnaire'), ('MEMBER', 'Membre'), ('TRAINER', 'Formateur')], default='MEMBER', max_length=20)),
                ...
                ('timezone', models.CharField(default='Africa/Abidjan', max_length=100)),
                ...
                ('receive_whatsapp_notification', models.BooleanField(default=True)),
